using backend_dotnet7.Core.Constant;
...
namespace backend_dotnet7.Core.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<GeneralServiceResponseDto> SeedRolesAsync()
        {
            ...
            if (isAdminRoleExists && isManagerRoleExists && isOwnerRoleExists && isUserRoleExists)
            ...
            return new GeneralServiceResponseDto()
            {
                IsSucceed = true,
                StatusCode = 201,
                Message = "Roles Seeding successfully Done"
            };
        ...
        public async Task<GeneralServiceResponseDto> RegisterAsync(RegisterDto registerDto)
        {
            ...
            //add default UserRoles to the all User
        ...
        public async Task<LoginServiceResponseDto?> LoginAsync(LoginDto loginDto)
        {
            ...
            //return new token and userinfo to frontend
